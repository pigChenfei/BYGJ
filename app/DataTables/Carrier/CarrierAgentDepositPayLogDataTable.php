...
class CarrierAgentDepositPayLogDataTable extends DataTable
{
    ...
    {
        $carrierAgentDepositPayLogs = CarrierAgentDepositPayLog::with(['agent','carrierPayChannel.payChannel','reviewUser'])
    ...
    private function getColumns()
    {
        return [
            ...
            '存款时间/单号' => ['name' => 'pay_order_number','data' => 'pay_order_number','defaultContent' => '','style' => 'text-align:center'],
            '账号' => ['name' => 'agent.username', 'data' => 'agent.username','defaultContent' => '','style' => 'text-align:center','render' => 'function(){
            ...
            '姓名' => ['name' => 'agent.realname', 'data' => 'agent.realname','defaultContent' => '','style' => 'text-align:center'],
            '存款金额' => ['name' => 'amount', 'data' => 'amount','defaultContent' => '','style' => 'text-align:center','searchable' => false],
            '手续费' => ['name' => 'fee_amount', 'data' => 'fee_amount','style' => 'text-align:center','searchable' => false],
            '实际到账' => ['name' => 'finally_amount', 'data' => 'finally_amount','style' => 'text-align:center','searchable' => false],
            '存款优惠' => ['name' => 'benefit_amount', 'data' => 'benefit_amount','style' => 'text-align:center','searchable' => false],
            '交易方式' => ['name' => 'carrier_pay_channel', 'data' => 'carrier_pay_channel.pay_channel.channel_name','defaultContent' => '','style' => 'text-align:center'],
            '存入银行' => ['name' => 'carrier_pay_channel', 'data' => 'carrier_pay_channel.display_name','defaultContent' => '','style' => 'text-align:center'],
            '状态' => ['name' => 'status', 'data' => 'statusName','style' => 'text-align:center'],
            '处理时间' => ['name' => 'updated_at', 'data' => 'updated_at','style' => 'text-align:center','searchable' => false],
            '凭证' => ['name' => 'credential', 'data' => 'credential','style' => 'text-align:center'],
            '备注' => ['name' => 'remark', 'data' => 'remark','style' => 'text-align:center'],
            '操作人' => ['name' => 'review_user_id','defaultContent' => '', 'render' => 'function(){
