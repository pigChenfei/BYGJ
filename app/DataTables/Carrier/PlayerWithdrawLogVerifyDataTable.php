...
class PlayerWithdrawLogVerifyDataTable extends DataTable
{
    ...
    public function ajax()
    {
        $dataTable = $this->datatables->eloquent($this->query())
            ...
            ->addColumn('status_name', function (PlayerWithdrawLog $log) {
    ...
    public function query()
    {
        $playerWithdrawLogs = PlayerWithdrawLog::with([
            ...
            'carrierOperator' => function ($builder) {
                return $builder->noSuperAdministrator();
            }
        ])->unReviewed()->orderBy('updated_at', 'desc');
