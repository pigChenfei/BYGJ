...
class AgentScatterReportDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables
            ->eloquent($this->query())
            ->addColumn('action', 'Agent.agent_scatter_report.datatables_actions')
...
//            })
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                $(".details_report").on("click",function(){
                    ...
                    $.fn.winwinAjax.buttonActionSendAjax(_me,"'.route('agentScatterReports.details',null).'/"+ id,{},function(content){
                        $.fn.overlayToggle();
    ...
    private function getColumns()
    {
        return [
            ...
            '洗码报表' => ['data' => '','defaultContent' => '查看详情','orderable' => false,'render' => 'function(){
