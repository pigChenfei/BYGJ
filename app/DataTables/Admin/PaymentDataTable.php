...
class PaymentDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return $this->datatables->eloquent($this->query())
            ->addColumn('action', 'Admin.payment.datatables_actions')
            ->make(true);
    }
    ...
    {
        $payChannels = PayChannel::with('payChannelType')->orderBy('updated_at', 'desc');
    ...
    private function getColumns()
    {
        return [
            ...
            '支付类型' => [
                'name' => 'id',
                'render' => 'function(){
                return this.pay_channel_type.type_name}'
            ],
            '创建时间' => [
                'name' => 'created_at',
                'data' => 'created_at'
