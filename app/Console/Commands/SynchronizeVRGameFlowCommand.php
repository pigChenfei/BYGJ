...
class SynchronizeVRGameFlowCommand extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'synchronizeGameData:vr';
    ...
    {
        try{
            $gameRunTime = new GameGatewayRunTime('vr',GameGatewayRunTime::PRODUCTION);
