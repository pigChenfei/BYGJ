...
class SynchronizeTTGGameFlowCommand extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'synchronizeGameData:ttg';
    ...
    public function handle()
    {
        try{
            \WLog::info('===========================================>进入TTG同步中');
            $gameRunTime = new GameGatewayRunTime('ttg',GameGatewayRunTime::PRODUCTION);
