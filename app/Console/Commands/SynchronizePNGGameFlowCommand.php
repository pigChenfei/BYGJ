...
class SynchronizePNGGameFlowCommand extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'synchronizeGameData:png';
    ...
    {
        try{
            $gameRunTime = new GameGatewayRunTime('png',GameGatewayRunTime::PRODUCTION);
