...
class UpdateCarrierActivityRequest extends FormRequest
{
    ...
    {
        $id = \Route::current()->parameter('carrierActivity');
        return CarrierActivity::updateRules(\WinwinAuth::carrierUser()->carrier_id,$id);
    }
