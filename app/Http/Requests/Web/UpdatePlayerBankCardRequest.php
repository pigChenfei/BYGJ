...
class UpdatePlayerBankCardRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'card_account' => 'string|min:16|max:19|required|unique:inf_player_bank_cards,card_account,'.$card_id.',card_id',
