...
class CarrierAgentDepositPayLogController extends AppBaseController
{
     ...
     * @return Response
     */
    public function index(CarrierAgentDepositPayLogDataTable $carrierAgentDepositPayLogDataTable)
    {
        return $carrierAgentDepositPayLogDataTable->render('Carrier.carrier_agent_deposit_pay_logs.index');
    }
