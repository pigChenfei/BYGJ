...
class TTG
{
    ...
    public function betRecord()
    {
        ...
        $param="<searchdetail requestId='".$requestId."''>"
              ."<daterange startDate='".$startDate."'' startDateHour='9' startDateMinute='10' endDate='".$endDate."' endDateHour='9' endDateMinute='15'/>"
              ."<account currency='CNY' />"
              ."<partner partnerId='".self::AFFILIATEID."' includeSubPartner='Y' />"
              ."<transaction transactionType='Game' transactionSubType='Wager' />"
              ."</searchdetail>";
