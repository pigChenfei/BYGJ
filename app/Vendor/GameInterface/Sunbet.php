...
class Sunbet {
    ...
    */
    public function login($accountUserName) 
    {
        ...
        {
            return array('username'=>$accountUserName,'authtoken'=>$output['authtoken']);
        }
    }
    ...
    */
    ...
    {
        $url=self::API_KICK;
        $output = $this->sbCurl($url, json_encode(array('userid'=>$accountUserName)));
    ...
    */
    ...
    public function transferOut($accountUserName,$money)
    {
        ...
        if(!$output)
        {
             return array('result'=>'unknown','accountUserName'=>$accountUserName,'money'=>$money,'ordernumber'=>$ordierId);
        }
        else if($output&&isset($output['bal']))
        {
             return array('result'=>true,'accountUserName'=>$accountUserName,'money'=>$money,'ordernumber'=>$ordierId);
        }
        else
        {
             return array('result'=>false,'accountUserName'=>$accountUserName,'money'=>$money,'ordernumber'=>$ordierId);
        }
    }
