        ...
        <div class="carousel-inner">
            ...
            @empty
                <div class="item active">
                	<a href="javascript:void(0)" style="background-image:url({!! asset('./app/template_one/img/videogame/banner1.jpg') !!})"></a>
                </div>
            @endforelse
        </div>
    </section>
        ...
        <article class="game-nav-container">
            <div class="game-menu-wrap clearfix">
                <ul class="game-menu list-unstyled">
                    ...
                    <li><a href="{!! route('homes.slot-machine', ['is_recommend' => 1]) !!}" @if(app('request')->input('is_recommend')) style="color: #d83c3d" @endif>推荐游戏</a></li>
                    <li><a href="{!! route('homes.slot-machine', ['is_new' => 1]) !!}" @if(app('request')->input('is_new')) style="color: #d83c3d" @endif>最新游戏</a></li>
                    {{--<li><a href="javascript:void(0)">特惠游戏</a></li>--}}
                    @if(\WinwinAuth::memberUser())
                        <li><a href="{!! route('homes.slot-machine', ['is_mine' => 1]) !!}" @if(app('request')->input('is_mine')) style="color: #d83c3d" @endif>我的游戏</a></li>
                    @endif
                </ul>
