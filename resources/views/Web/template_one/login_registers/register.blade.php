...
<style>
.bgwrap{
	background: url({!! asset('./app/template_one/img/common/recommend-bg.jpg')!!}) no-repeat center center;
		...
		<form role="form" method="post" id="registerForm" novalidate="novalidate">
			...
			<div class="form-box" style="padding-top:0;">
				...
				<div class="form-inline clearfix">
					...
					<input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="确认密码" autocomplete="off" required="" data-msg-required="请输入确认密码"
			...
			<div class="form-box">
				...
				<div class="form-inline clearfix">
					...
					<input type="text" class="form-control" name="referral_code" id="referral_code" autocomplete="off" placeholder="请输入邀请码" @if($recommend_code) style="background: #000;" value="{!! $recommend_code !!}" readonly @endif>
				...
				<div class="form-inline clearfix check-rule">
					...
					<span>我已同意并阅读&nbsp;&nbsp;
						<a href="javascript:void(0)" style="color: #d8a659!important;">“服务和条款”</a>
					</span>
				</div>
