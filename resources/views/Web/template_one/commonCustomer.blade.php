...
<section class="aboutus-main">
        	<div class="main-wrap clearfix">
        		<aside class="float-left">
        			...
        			<div class="item active" data-id="box2"><a href="{!! url('homes.contactCustomer?type=common') !!}">常见问题<span class="glyphicon glyphicon-menu-right"></span></a></div>
        			<div class="item" data-id="box3"><a href="{!! url('homes.contactCustomer?type=duty') !!}">责任博彩<span class="glyphicon glyphicon-menu-right"></span></a></div>
        		</aside>
