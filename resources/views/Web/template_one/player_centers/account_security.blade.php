                    ...
                    <div class="art-body">
                        ...
                        <div class="memb-box text-center cpwd-normal">
                            <div class="form-inline">
                                ...
                                <div style="display: inline-block;margin-left: 18px;vertical-align: middle;">{!! \WinwinAuth::memberUser()->user_name !!}</div>
                            </div>
                            <div class="form-inline level-wrap">
                                ...
                                <div style="display: inline-block;margin-left: 18px;vertical-align: middle;width:280px;line-height:30px;">
                                    <div style="display: inline-block;vertical-align: middle;">{{\WinwinAuth::memberUser()->playerLevel->level_name}}</div>
                                    ...
                                    <a style="color: #d8a659;" class="float-right level-detail" href="javascript:">关于提升等级说明 >
                                        <div class="level-tip">
                                            <div>如何提高会员等级</div>
                                            <div class="table">
