...
<div class="steptwo">
	...
	<div class="memb-box" style="padding-left:30px;">
		<div class="form-inline mt-20">
            ...
            <em class="ml-20">{!! $otherPay->payChannel->channel_name !!}</em>
		</div>
		<div class="form-inline">
			<label for="pay-info">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：</label>
			<em class="ml-20">{!! $otherPay->owner_name !!}</em>
		</div>
		<div class="form-inline">
			<label for="pay-info">卡&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</label>
			<em class="ml-20">{!! $otherPay->account !!}</em>
		</div>
		<div class="form-inline">
			<label for="pay-info">开户分行：</label>
			<em class="ml-20">{!! $otherPay->card_origin_place !!}</em>
		</div>
	</div>
	<p>存款账号信息(带<i class="font-red">&nbsp;✱&nbsp;</i>为必填项目)</p>
	<div class="memb-box" style="padding-left:30px;">
