        ...
        <!--实时洗码-->
            <article class="livecode">
                ...
                <div class="art-body">
                    ...
                    <div class="yue-count">
                        <span>可结算洗码金额&nbsp;&nbsp;<i class="font-red"><span id="settleAllAmount">{!! $settleAmountTotal !!}</span>元</i></span>
                        ...
                        <table class="table text-center">
                            ...
                            @foreach($playerRebateFinancialFlow as $item)
                                <tr>
                                    ...
                                    <td class="settleTd" style="vertical-align: middle"><a href="javascript:" class="at-real settleOne text-warning" data="{!! $item->id !!}" style="text-decoration:underline">立即结算</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
