        ...
        <form id="onlinePayForm">
          <div class="list-block">
            <ul>
              ...
              <li>
                <div class="item-content item-link bank_no">
                  <div class="item-inner">
                    <div class="item-title">支付方式：</div>
                    <div class="item-after">请选择银行</div>
                    <input type="hidden" id="bank_no">
                    <input type="hidden" name="bank_no">
                    <input name="pay_type" type="hidden" id="pay_type" value="{{ !empty($gateway)?$gateway:'' }}">
                  </div>
                </div>
              </li>
            </ul>
              ...
              <li>
                <div class="item-content item-link discount">
                  <div class="item-inner">
                    ...
                    <input id="discount" name="activityId" type="hidden">
                  </div>
                </div>
              </li>
            </ul>
...
@section('script')
    ...
    tools.picker($('#bank_no'), '请选择银行', scanArr)
    $('.bank_no').click(function(){
    	$('#bank_no').picker('open');
    })
    $('#bank_no').on('change',function(){
    	$('.bank_no .item-after').text($(this).val())
    	$('input[name=bank_no]').val(scanObj[$(this).val()]);
    })
