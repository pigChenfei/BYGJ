    ...
    <script>
        $(function(){
            $("#type").change(function(){
                ...
                $.ajax({
                    url:"{!! route('agents.dataAgentLevel') !!}", //你的路由地址
                    type:"post",
                    dataType:"json",
                    data:objectModel,
                    timeout:30000,
    ...
    <div class="container">
        ...
        <form class="form-horizontal" role="form" method="post" id="jsForm">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <input type="text" class="form-control" name="realname" id="username" placeholder="请输入真实姓名" required data-rule-username='true' data-msg-required='请输入真实姓名' data-msg-username='必须与取款银行卡姓名一致'>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <input type="text" class="form-control" name="realname" id="username" placeholder="请输入真实姓名"  data-rule-username='true' data-msg-required='请输入真实姓名' data-msg-username='必须与取款银行卡姓名一致'>
                </div>
                <p class="input_tips col-lg-12 col-md-12 col-xs-12 col-sm-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">必须与取款银行卡姓名一致</p>
            </div>
            @else
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    ...
                    <select name="" id="type" style="height: 34px;color: black;">
                        @foreach($typeDic as $key => $value)
                        <option value="{!! $key !!}">{!! $value !!}</option>
                        @endforeach
                    </select>

                    <select name="agent_level_id" id="agentways" style="height: 34px;color: black;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    ...
                    <select name="agent_level_id" id="agent_level_id" style="height: 34px;color: black;">
                        @if(isset($carrierAgentLevelName))
                            @foreach($carrierAgentLevelName as $key => $value)
                                <option value="{!! $value->id !!}">{!! $value->level_name !!}</option>
                            @endforeach
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <textarea name="promotion_notion" rows="3" style="width: 210px;color: black;" placeholder="请填写您的邀请介绍" required data-rule-introduce='true' data-msg-required='邀请介绍必填' data-msg-introduce='邀请介绍20-100个字符'></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <textarea name="promotion_notion" rows="3" style="width: 210px;color: black;" placeholder="请填写您的邀请介绍"  data-rule-introduce='true' data-msg-required='邀请介绍必填' data-msg-introduce='邀请介绍20-100个字符'></textarea>
                </div>
            </div>
            @else
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10" id="div_refercode">
                    <input type="text" class="form-control" name="refercode" id="refercode" placeholder="请输入验证码" required style="width: 130px;float: left;" data-rule-refercode='true' data-msg-required='验证码必填' data-msg-refercode='验证码输入错误'>
                    <span id="identify_code" class="captchaChange">{!! \Captcha::img() !!}</span>
                </div>
            </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"><i class="glyphicon glyphicon-ok-sign"></i>代理账号注册成功,请等待客服审核!</div>
