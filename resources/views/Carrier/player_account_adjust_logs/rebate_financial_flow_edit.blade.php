<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle">调整会员洗码</h4>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <input type="hidden" name="adjust_type" value="{!! \App\Models\Log\PlayerAccountAdjustLog::ADJUST_TYPE_REBATE_FINANCIAL_FLOW !!}">
