    ...
    <div class="content">
        ...
        <div class="box box-primary color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tag"></i> 代理域名列表</h3>
                <div class="box-tools">
            ...
            <div class="box-body">
                @include('Carrier.carrier_agent_domains.table')
                <h5 class="pull-left">
                    ...
                    <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px;margin-left: 15px" onclick="{!! TableScript::addOrEditModalShowEventScript(route('carrierAgentDomains.create')) !!}">新增代理域名</a>
                </h5>
            </div>
