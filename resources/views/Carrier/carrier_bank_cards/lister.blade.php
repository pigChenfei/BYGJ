<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <form id="bank_cards_select_form">
            ...
            <input type="hidden" name="player_level_id" value="{!! $carrierPlayerLevel->id !!}">
                ...
                <table class="table table-bordered no-footer table-responsive">
                    ...
                    <tbody>
                        <?php
                                ...
                                $carrierPlayerLevelBankCardIds = $carrierPlayerLevel->bankCardMap->map(function($element){
                                        return $element->carrier_bank_card_id;
                                })->toArray();

                        ?>
                        @foreach($carrierBankCards as $carrierBankCard)
                            <tr role="row">
                                <td style="text-align: center">

                                    <input class="checkbox selected_bank_checkbox" {!! in_array($carrierBankCard->bank_card_id,$carrierPlayerLevelBankCardIds) ? 'checked' : '' !!} name="selected_bank[]" value="{!! $carrierBankCard->bank_card_id !!}" type="checkbox">
                                </td>
                                <td>
                                    {!! $carrierBankCard->cardBankType->bank_name !!}
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    {!! \App\Models\CarrierBankCard::usedForPurposeMeta()[$carrierBankCard->use_purpose] !!}
                                </td>
                                <td>
                                    {!! \App\Models\Def\BankType::bankTypeMeta()[$carrierBankCard->cardBankType->bank_type] !!}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
