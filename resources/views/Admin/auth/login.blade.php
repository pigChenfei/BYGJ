...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/src/_all-skins.min.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><b>主后台 </b>Generator</a>
    </div>
    ...
    <div class="login-box-body">
        ...
        <form method="post" action="{{ route('login') }}">
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? ' has-error' : '' }}">
                <input class="form-control" value="" name="username" value="{{ old('username') }}" placeholder="Email">
...
<script src="/src/js/jquery-1.12.0.min"></script>
