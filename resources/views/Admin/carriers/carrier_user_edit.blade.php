            ...
            <div class="row">
                <form id="carrier_user_create_form">
                    <div class="form-group col-sm-12">
                        <label for="">用户名</label>
                        <input readonly value="{!! $carrierUser->username !!}" type="text" class="form-control">
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="">密码</label>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <select name="service_team" id="" class="form-control">
                            @foreach($carrier->serviceTeams as $serviceTeam)
                                <option {!! $carrierUser->team_id == $serviceTeam->id ? 'selected' : '' !!} value="{!! $serviceTeam->id  !!}">{!! $serviceTeam->team_name  !!}</option>
                            @endforeach
                        </select>
                    </div>
                </form>
            ...
            <div class="form-group col-sm-12">
                <div class="btn-group">
                    <button id="save" type="button" onclick="var _me = this;$.fn.winwinAjax.buttonActionSendAjax(
                            _me,
                            '{!! route('carriers.updateUser',$carrierUser->id) !!}',
