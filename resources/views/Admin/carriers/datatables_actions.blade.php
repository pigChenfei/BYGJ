<div class='btn-group'>
    <button onclick="{!! TableScript::addOrEditModalShowEventScript(route('carriers.edit', $id)) !!}" class='btn btn-default btn-xs'>
    ...
    <a class="btn btn-primary btn-xs" target="_blank" href="{!! route('loginCarrierSystem',$id) !!}">登录后台</a>
</div>
