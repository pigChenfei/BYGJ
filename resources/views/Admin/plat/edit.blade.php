...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <form method="POST" action="{{ route('plats.update',['id'=>$payChannel->main_game_plat_id]) }}" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="main_game_plat_name" type="text" id="main_game_plat_name" value="{{ old('main_game_plat_name') ?: $payChannel->main_game_plat_name }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="main_game_plat_code" class="col-sm-2 text-right">主平台代码:</label>
                            <div class="col-sm-6">
                                <input class="form-control" name="main_game_plat_code" type="text" id="main_game_plat_code" value="{{ old('main_game_plat_code') ?: $payChannel->main_game_plat_code }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="account_pre" class="col-sm-2 text-right">生成帐号前辍:</label>
                            <div class="col-sm-6">
                                <input class="form-control" name="account_pre" type="text" id="account_pre" value="{{ old('account_pre') ?: $payChannel->account_pre }}">
                            </div>
                        </div>
