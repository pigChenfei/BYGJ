    ...
    <div class="content">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tag"></i> 支付类型列表</h3>
                <div class="box-tools">
            ...
            <div class="box-body">
                ...
                <h5 class="pull-left">
                    ...
                    <a class="btn btn-primary pull-left" style="margin-top: -10px;margin-bottom: 5px" onclick="location.href='{{route('payTypes.create')}}'">新增支付类型</a>
                </h5>
            </div>
