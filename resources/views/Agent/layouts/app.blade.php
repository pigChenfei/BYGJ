...
<head>
    ...
    <link rel="stylesheet" href="/app/template_one/css/agency.css">
    @yield('css')
    <style>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">{!! WinwinAuth::agentUser()->name !!}</span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {!! WinwinAuth::agentUser()->name !!}
                                        <small>Member since {!! WinwinAuth::agentUser()->created_at->format('M. Y') !!}</small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="{!! url('agent/admin/logout') !!}" class="btn btn-default btn-flat"
                                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                            Sign out
                                        </a>
                                        <form id="logout-form" action="{{ url('agent/admin/logout') }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </div>
                                </li>
