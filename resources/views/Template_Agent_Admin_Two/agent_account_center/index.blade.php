        ...
        <div class="art-body">
            ...
            <div class="memb-box">
                <div class="tg-website">
                    <span style="color: rgba(0, 0, 0, 0.9)" style="display:inline-block;vertical-align:middle;">邀请链接：<input type="text" id="recommend-link" value="{!! $agentAccountCenter->promotion_url !!}" readonly/></span>
                    <button class="btn btn-warning" style="display:inline-block;vertical-align:middle;margin-left:18x;" onclick="jsCopy()">点击复制</button>
