            ...
            <div class="art-body">
                ...
                <div class="memb-box">
                    <div class="form-inline table" style="margin-bottom: 20px;margin-left: 10px;">
                        <div class="table-cell"><i style="color:rgba(0,0,0,0.9);">可取金额：</i><i class="font-red can-draw" style="padding-left:18px;">{!! \WinwinAuth::agentUser()->amount !!}</i></div>
                    </div>
                    ...
                    <div class="dialog-body text-center">
                        ...
                        <div class="form-inline">
                            <div class="dropdown mb-10">
                                ...
                                <button class="btn dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" style="margin-left:3px;background:none!important;height:33px;border:0;border-bottom:1px solid #ccc;font-size:12px;"/>
        ...
        <div class="dialog-wrap">
            ...
            <div class="del-card" >
                ...
                <div class="dialog-foot clearfix">
                    <button class="btn btn-warning float-left shanchu-bank" style="width: 140px;">是</button>
                    <button class="btn btn-warning2 float-right" onclick="$(this).parents('.masklayer').hide();" style="width: 140px;">否</button>
                </div>
            </div>
            <!--关闭-->
            <div class="dialog-close" onclick="$(this).parents('.masklayer').hide();"></div>
