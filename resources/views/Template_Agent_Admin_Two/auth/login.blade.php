...
<div class="login-box">
    <div class="login-logo">
        <a style="color: whitesmoke" href="{{ url('/home') }}"><b>博赢国际 </b>代理后台</a>
    </div>
    ...
    <div class="login-box-body">
        ...
        {{--<a href="{{ url('/agent/password/reset') }}">忘记密码</a><br>--}}
        {{--<a href="{{ url('/agent/register') }}" class="text-center">注册新账号</a>--}}
...
<script>
    $(function () {
        ...
        var field = "beingWallPaperAgent" + date;
